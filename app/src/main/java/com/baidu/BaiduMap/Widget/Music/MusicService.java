...
//        mediaSession.setMetadata(metaBuilder.build());
    ...
    public MediaMetadataCompat defaultMetadata() {
        MediaMetadataCompat.Builder metaBuilder = new MediaMetadataCompat.Builder().putString(MediaMetadataCompat.METADATA_KEY_TITLE, "")
                .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, "等待播放").putBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART, null);
