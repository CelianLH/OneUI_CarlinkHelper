...
import com.baidu.BaiduMap.carlifeapplauncher.Window.AppsUI;
import com.baidu.BaiduMap.Widget.Music.MusicUI;
import com.baidu.BaiduMap.carlifeapplauncher.widget.LauncherAppWidgetHost;
...
public class MainActivity extends AppCompatActivity {
    ...
    private com.baidu.BaiduMap.databinding.ActivityMainBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = com.baidu.BaiduMap.databinding.ActivityMainBinding.inflate(getLayoutInflater());
...
//        }
    ...
    private void background() {
        ImageView imageView = this.findViewById(R.id.backgroundimage);
        if (!CarLinkData.getBoolean(this, CarLinkData.sp_overlay_left_dock_corner_always, false)) {

            switch (CarLinkData.getString(this, CarLinkData.sp_theme_launcher_bg_pic)) {
                case "0":
                    imageView.setBackground(this.getDrawable(R.drawable.wallpaper_0));
                    break;
                case "1":
                    imageView.setBackground(this.getDrawable(R.drawable.wallpaper_1));
                    break;
                case "2":
                    imageView.setBackground(this.getDrawable(R.drawable.wallpaper_2));
                    break;
                case "3":
                    imageView.setBackground(this.getDrawable(R.drawable.wallpaper_3));
                    break;
            }
        }
    }
    ...
    private void component() {
        ...
        for (String co : component) {
            ...
            switch (plugin) {
                case "app":
                    AppsUI appsUI = new AppsUI(this, getLayoutInflater(), location_vg);
                    break;
                case "music":
