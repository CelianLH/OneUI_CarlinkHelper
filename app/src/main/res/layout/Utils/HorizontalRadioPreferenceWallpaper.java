...
public class HorizontalRadioPreferenceWallpaper extends Preference {
    ...
    public HorizontalRadioPreferenceWallpaper(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR =
                new Creator<HorizontalRadioPreferenceWallpaper.SavedState>() {
                    @Override
                    public HorizontalRadioPreferenceWallpaper.SavedState createFromParcel(Parcel in) {
                        return new HorizontalRadioPreferenceWallpaper.SavedState(in);
                    }

                    @Override
                    public HorizontalRadioPreferenceWallpaper.SavedState[] newArray(int size) {
                        return new HorizontalRadioPreferenceWallpaper.SavedState[size];
                    }
                };
        String value;
