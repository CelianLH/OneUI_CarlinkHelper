...
public class HorizontalRadioPreferenceTheme extends Preference {
    ...
    public HorizontalRadioPreferenceTheme(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContex = context;
        ...
        a = context.obtainStyledAttributes(attrs, R.styleable.HorizontalRadioPreference);
        ...
        if (mType == IMAGE) {
            imageHeight = a.getInt(R.styleable.HorizontalRadioPreference_imageHeight, -1);
            ...
            switch (mType) {
                ...
                case IMAGE:
                    ...
                    itemLayout.findViewById(R.id.image_frame)
                            .setVisibility(View.VISIBLE);
                    WindowManager windowManager = (WindowManager) mContex.getSystemService(Context.WINDOW_SERVICE);
                    ImageView imageView = ((ImageView) itemLayout.findViewById(R.id.icon));
                    LinearLayout linearLayout = ((LinearLayout) itemLayout.findViewById(R.id.image_frame));
    ...
    private static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR =
                new Creator<HorizontalRadioPreferenceTheme.SavedState>() {
                    @Override
                    public HorizontalRadioPreferenceTheme.SavedState createFromParcel(Parcel in) {
                        return new HorizontalRadioPreferenceTheme.SavedState(in);
                    }

                    @Override
                    public HorizontalRadioPreferenceTheme.SavedState[] newArray(int size) {
                        return new HorizontalRadioPreferenceTheme.SavedState[size];
                    }
                };
        String value;
